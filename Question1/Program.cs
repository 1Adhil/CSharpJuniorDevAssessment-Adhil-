        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            foreach(var id in idNumberList)
            {
                ...
                //added yyMMdd format
                Console.WriteLine($"Person Date Of Birth: {person.DateOfBirth.ToString("yyMMdd")}");
        ...
        {
            // Creating PersonCreator instance to access createperson method
            var CreateId = new PersonCreator(new PersonBuilder());
            CreateId.CreatePerson(idNumber);
            return CreateId.GetPerson();
        }
    }
}
